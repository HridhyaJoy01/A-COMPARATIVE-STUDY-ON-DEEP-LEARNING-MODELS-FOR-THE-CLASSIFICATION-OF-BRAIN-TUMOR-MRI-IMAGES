...
# preprocessing the training images for classification
...
# preprocessing the testing images for classification
labels = ['glioma', 'meningioma', 'notumor', 'pituitary']
x_test = []
y_test = []
...
# visualizing random selection of images
...
# shuffling and splitting of dataset into train_validation_test
